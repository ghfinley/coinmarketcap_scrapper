...
for i in range(5):  #create a for loop to download data multiple times, in real life you want to make this like 1000 or 5000 so that the program runs for 2 weeks or so 
	...
	response = urllib.request.urlopen("http://coinmarketcap.com/") #puts the request for the url in a variable to get another page (.com/?page=2)
	...
	time.sleep(30) #tell python how long to wait until it runs the loop again, in real life this needs to be at least 300 for 5 minutes to avoid being blocked by the website 
